...
3. **Feature Selection.** We can attempt stepwise, lasso, principal components reduction and partial least squares to improve our feature selection.
4. **Regularization.** We can use ridge, lasso, and elastic net regression to regularize our model and prevent over-fitting.
...
* How to use a variety of techniques to reduce dimensionality.
...
# Feature Selection via Model Selection
